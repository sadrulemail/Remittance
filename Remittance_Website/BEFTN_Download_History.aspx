<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="Remittance.BEFTN_Download_History" CodeFile="BEFTN_Download_History.aspx.cs" %>
        ...
        <ContentTemplate>
                ...
                <tr>
                    <td>
                        <table class="SmallFont ui-corner-all Panel1">
                            <tr>
                                <td style="padding-left: 10px; white-space: nowrap; text-align: right">Export From Branch:
                                </td>
                                <td>
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSourceBranch" runat="server" ConnectionString="<%$ ConnectionStrings:RemittanceConnectionString %>"
                                        SelectCommand="SELECT [BranchID], [BranchName] FROM [V_BranchOnly] ORDER by BranchName" EnableCaching="true" CacheDuration="600"></asp:SqlDataSource>
                                </td>
                                <td style="padding-left: 10px">Type:</td>
                                <td>
                                    <asp:DropDownList ID="cboPaymentType" AppendDataBoundItems="true" AutoPostBack="true" runat="server" DataSourceID="SqlDataSource2" DataTextField="PaymentTypeName" DataValueField="PaymentType">
                                        <asp:ListItem Text="All" Value="*"></asp:ListItem>
                                    </asp:DropDownList>
                                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:RemittanceConnectionString %>" 
                                        SelectCommand="SELECT [PaymentType], [PaymentTypeName] FROM [PaymentTypes] WHERE ([Active] = 1) ORDER BY [OrderCol]">
                                        
                                    </asp:SqlDataSource>
                                </td>
                                <td style="padding-left: 10px; white-space: nowrap; text-align: right">Export Date: from
                                </td>
                                <td>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Font-Size="Small"
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <a href='BEFTN_Download.aspx?batch=<%# Eval("BatchID") %>&PaymentType=<%# Eval("PaymentType") %>'>
                                <img src='Images/ext/xls.gif' width='16' height='16' border='0' title='xlsx' /></a>
                            &nbsp;&nbsp;<a href='BEFTN_Download.aspx?batch=<%# Eval("BatchID") %>&PaymentType=<%# Eval("PaymentType") %>&view=yes' target="_blank"><img
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RemittanceConnectionString %>"
                SelectCommand="sp_BEFTN_Export_Log_Browse" SelectCommandType="StoredProcedure"
                ...
                <SelectParameters>
                    ...
                    <asp:ControlParameter ControlID="cboPaymentType" Name="PaymentType" PropertyName="SelectedValue" Type="String"
                         />
                </SelectParameters>
            </asp:SqlDataSource>
            <br />
