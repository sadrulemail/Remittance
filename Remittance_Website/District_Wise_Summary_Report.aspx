<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    Inherits="District_Wise_Summary_Report" CodeFile="District_Wise_Summary_Report.aspx.cs" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RemittanceConnectionString %>"
                ...
                OnSelected="SqlDataSource1_Selected" CacheDuration="120" EnableCaching="false"
                CacheKeyDependency="RITCacheKey" OnInserting="SqlDataSource1_Inserting" OnSelecting="SqlDataSource1_Selecting">
                <SelectParameters>
                    ...
                    <asp:ControlParameter ControlID="txtDateTo" Name="Tdate" PropertyName="Text" Type="DateTime"
                        ConvertEmptyStringToNull="true" DefaultValue="1/1/1900" />
                    <asp:ControlParameter Name="ExHouses" Size="-1" DbType="String" ControlID="hidExHouses" PropertyName="Value" DefaultValue="*" />
                </SelectParameters>
            </asp:SqlDataSource>
            <table>
                <tr>
                    <td>
                        <table class="SmallFont Panel1">
                            <tr>
                                ...
                                <td>
                                    <asp:ListBox ID="cboExHouse" runat="server" AppendDataBoundItems="true" 
                                        SelectionMode="Multiple" Height="25px"
                                        DataSourceID="sqlExHouse" DataTextField="ExHouseName" 
                                        DataValueField="ExHouseCode">
                                    </asp:ListBox>
                                    <asp:HiddenField ID="hidExHouses" runat="server" Value="*" />
                                    <asp:SqlDataSource ID="sqlExHouse" runat="server" ConnectionString="<%$ ConnectionStrings:RemittanceConnectionString %>"
