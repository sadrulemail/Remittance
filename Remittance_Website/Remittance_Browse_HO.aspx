<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    Inherits="Remittance.Remittance_Browse_HO" CodeFile="Remittance_Browse_HO.aspx.cs" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate> 
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RemittanceConnectionString %>"
                SelectCommand="sp_RemiList_Browse_HO" SelectCommandType="StoredProcedure" OnSelected="SqlDataSource1_Selected"
                EnableCaching="false">
                <SelectParameters>
