...
public static class Common
{
    ...
    public static ServiceLockStatus CheckServiceLockStatus(string ApplicationID, string MethodName, string EmpID)
    {
    ...
    public static void UpdateServiceLockStatus(string ApplicationID, string MethodName,string EmpID)
    {
        try
        {
            using (SqlConnection conn = new SqlConnection())
