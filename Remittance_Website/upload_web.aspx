<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    Inherits="Remittance.Upload_Web" CodeFile="Upload_Web.aspx.cs" %>
        ...
        <ContentTemplate>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="PaidOn" HeaderText="Paid On" SortExpression="PaidOn"
                        DataFormatString="{0:dd-MMM-yyyy}" ItemStyle-Wrap="false" ReadOnly="true">
                        <ItemStyle Wrap="False" />
                    </asp:BoundField>                    
                    ...
                    <asp:BoundField DataField="FxAmount" HeaderText="Fx Amount" SortExpression="FxAmount"
                        ReadOnly="true" />
                    <asp:BoundField DataField="FxCurrency" HeaderText="Fx Currency" SortExpression="FxCurrency"
                        ReadOnly="true" />
                    <asp:BoundField DataField="CommentHO" HeaderText="Country" SortExpression="CommentHO"
                        ReadOnly="true" />
                </Columns>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="SELECT * FROM TempUpload_WEB WHERE (SessionID = @SessionID) AND (EmpID = @EmpID) ORDER BY ID"
                UpdateCommand="UPDATE TempUpload_WEB SET ToBranch = @ToBranch, CommentHO = @CommentHO WHERE (ID = @ID)"
                    ...
                    <tr>
                        ...
                        <td class="ui-corner-all Shadow Border" width="360px">
                            <table>
                                ...
                                <tr>                                    
                                    <td nowrap="nowrap" style="padding-right: 10px">
                                        <span style="font-size: small;"><b>Paid Date:</b></span>
                                    </td>
                                    <td style="margin-left: 40px">
                                        <asp:TextBox runat="server" ID="txtPaidDate" Text="" Width="130" MaxLength="20" CssClass="Watermark Date" Watermark="dd/mm/yyyy"></asp:TextBox>                                        
                                    </td>
                                </tr>
                                <tr>
                                    <td nowrap="nowrap" style="padding-right: 10px">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:Button ID="cmdUpdate" runat="server" Font-Bold="true" Height="30px" OnClick="cmdUpdate_Click"
                                            Text="Upload Data" ValidationGroup="Submit" Width="220px" />
            ...
            <asp:SqlDataSource ID="SqlDataSourceRemiList_Add" runat="server" ConnectionString="<%$ ConnectionStrings:RemittanceConnectionString %>"
                ...
                SelectCommand="sp_RemiList_Add_Web" SelectCommandType="StoredProcedure" OnSelected="SqlDataSourceRemiList_Add_Selected">
                <SelectParameters>
                    <asp:ControlParameter Name="SessionID" ControlID="HidPageID" PropertyName="Value"
                        Type="String" />
                    <asp:ControlParameter ControlID="txtTestNo" Name="TestNumber" PropertyName="Text"
                        Type="String" />
                    <asp:ControlParameter ControlID="txtPaidDate" Name="ValueDate" PropertyName="Text"
            ...
            <br />
            <asp:ObjectDataSource ID="ObjectDataSourceMapping" runat="server" DeleteMethod="Delete" InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="DataSetMapTableAdapters.Branch_MappingTableAdapter" UpdateMethod="Update">
            ...
            <asp:ObjectDataSource ID="ObjectDataSourceRITCountry" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="DataSetMapTableAdapters.v_RIT_CountryCodesTableAdapter">                              
            </asp:ObjectDataSource>
            <asp:ObjectDataSource ID="ObjectDataSourceBranchOnly" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="DataSetMapTableAdapters.v_BranchOnlyTableAdapter">                              
            </asp:ObjectDataSource>
        </ContentTemplate>
    </asp:UpdatePanel>
