<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="Remittance.Flora_Download_History" CodeFile="Flora_Download_History.aspx.cs" %>
        ...
        <ContentTemplate>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Font-Size="Small"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="ExHouseName" HeaderText="ExHouse Name" SortExpression="ExHouseName" ItemStyle-HorizontalAlign="Left" />
                    ...
                    <asp:TemplateField HeaderText="Download">
                        <ItemTemplate>
                            <a href='Flora_Download.aspx?batch=<%# Eval("BatchID") %>&format=txt' target="_blank"><img src='Images/ext/txt.gif' width='16' height='16' border='0' title='txt' /></a>
                            &nbsp;
                            <a href='Flora_Download.aspx?batch=<%# Eval("BatchID") %>&format=xlsx' target="_blank"><img src='Images/ext/xls.gif' width='16' height='16' border='0' title='xlsx' /></a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField >
                        <ItemTemplate>
                            <a href='Flora_Download.aspx?batch=<%# Eval("BatchID") %>&format=view' target="_blank"><img src='Images/open.png' width='16' height='16' border='0' title='View' /></a>                            
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
                <EmptyDataTemplate>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RemittanceConnectionString %>"
                SelectCommand="sp_Flora_Export_Log_Browse" SelectCommandType="StoredProcedure"
