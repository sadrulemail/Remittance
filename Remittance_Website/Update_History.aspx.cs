...
public partial class Update_History : System.Web.UI.Page
{
    ...
    //            worksheet.Cells[StartRow, 7].Value = "Paymnet Method";
    //            worksheet.Cells[StartRow, 8].Value = "Exhouse Code";
    //            worksheet.Cells[StartRow, 9].Value = "To Branch Name";
    //            worksheet.Cells[StartRow, 10].Value = "Routing Number";
    //            worksheet.Cells[StartRow, 11].Value = "Remitter Name";
    //            worksheet.Cells[StartRow, 12].Value = "Beneficiary Name";
    ...
    //                    worksheet.Cells[R, 8].Value = DV.Table.Rows[r]["ExHouseName"].ToString();

    //                if (DV.Table.Rows[r]["ToBranchName"] != DBNull.Value)
    //                    worksheet.Cells[R, 9].Value = DV.Table.Rows[r]["ToBranchName"].ToString();

    //                if (DV.Table.Rows[r]["RoutingNumber"] != DBNull.Value)
    //                    worksheet.Cells[R, 10].Value = DV.Table.Rows[r]["RoutingNumber"].ToString();

    //                if (DV.Table.Rows[r]["RemitterName"] != DBNull.Value)
    //                    worksheet.Cells[R, 11].Value = DV.Table.Rows[r]["RemitterName"].ToString();

    //                if (DV.Table.Rows[r]["BeneficiaryName"] != DBNull.Value)
    //                    worksheet.Cells[R, 12].Value = DV.Table.Rows[r]["BeneficiaryName"].ToString();
